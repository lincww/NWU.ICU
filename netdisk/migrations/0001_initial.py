    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('describe', models.TextField(max_length=10240, verbose_name='Description')),
                ('hash', models.TextField(max_length=16, verbose_name='MD5 hash of the file')),
                ('location', models.CharField(blank=True, max_length=1024, verbose_name='Location of the file')),
