...
class SingleFile(models.Model):
    ...
    storage_provider = models.CharField(verbose_name="Provider of the storage: OSS/QiNiu", max_length=128, blank=True)
    storage_uri = models.CharField(verbose_name="URI of the file in given provider", max_length=1024, blank=True)
